...
export default function Accordian(){
    ...
    return <div className="accordian__wrapper">
        ...
        <div className="accordian">
            {
                data && data.length >0 ? 
                data.map(item=><div className="accordian__item" key={item.id}>
                    <div className="accordian__title" onClick={
                    ...
                    {
                        enableMultiSelection ?
                        multiple.indexOf(item.id)!==-1 && <div className="accordian__content">{item.answer}</div>
                        : selected===item.id && <div className="accordian__content">{item.answer}</div>
                    }
                    {/* {
